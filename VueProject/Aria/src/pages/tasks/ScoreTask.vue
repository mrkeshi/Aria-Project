                ...
                <div class="flex w-full flex-wrap max-md:justify-center justify-end mx-2 mt-6 ">
                    ...
                    <div class="flex flex-wrap ">
                        ...
                        <button class="flex items-center mx-2 px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                            ...
                            <RouterLink :to="{name:'task'}" class="mx-1 text-sm text-white">مدیریت وظایف</RouterLink>
                        </button>
                    </div>
                </div>    
            </div>
                ...
                <div class="flex items-center shadow-md mt-8 max-lg:mt-4 bg-white w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                    <div class="w-full">
                        ...
                        <form @submit.prevent="send" class="flex flex-col ">
                                ...
                                <div class="mt-4">
                                    <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">امتیاز </label>
                              
                                    <input v-model="taskStore.task.rate" placeholder="از 100 امتیاز" type="number" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40">
                                </div>
                                <div class="mt-4">
                                    <label class="block mb-2 text-base text-gray-700 dark:text-gray-200">بازخورد </label>
                                    <textarea v-model="taskStore.task.owner_note" rows="5" placeholder="بازخوردتان را نسبت به شخص انجام دهنده وارد کنید." class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"></textarea>
                                </div>
...
const send = async () => {
    ...
    if (!loading.value) {
        ...
        await taskStore.scoretaskadmin({
