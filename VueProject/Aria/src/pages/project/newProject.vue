<template>
    <div>
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8 px-4 ">
                <h1 class="text-gray-700 font-bold text-xl" >پروژه جدید</h1>
                <p class="text-gray-600 text-sm text-wrap">شما در این قسمت می توانید پروژه جدید را تعریف و اضافه کنید</p>
...
onMounted(async() => {
  ...
  if(!Sub.Permissions.addprject || !Sub.isActive){
